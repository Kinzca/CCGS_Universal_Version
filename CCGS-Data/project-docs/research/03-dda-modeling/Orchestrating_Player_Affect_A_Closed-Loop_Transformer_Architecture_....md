# Orchestrating Player Affect: A Closed-Loop Transformer Architecture ...
...
[1. Introduction](https://www.preprints.org/manuscript/202512.1305/v1#Introduction)

[2. Related Work](https://www.preprints.org/manuscript/202512.1305/v1#Related_Work)

[3. Ethical Considerations](https://www.preprints.org/manuscript/202512.1305/v1#Ethical_Considerations)

[4. Methodology](https://www.preprints.org/manuscript/202512.1305/v1#Methodology)

[5. Results and Discussion](https://www.preprints.org/manuscript/202512.1305/v1#Results_and_Discussion)

[6. Conclusion](https://www.preprints.org/manuscript/202512.1305/v1#Conclusion)

[Author Contributions](https://www.preprints.org/manuscript/202512.1305/v1#Author_Contributions)

[Funding](https://www.preprints.org/manuscript/202512.1305/v1#Funding)

[Informed Consent Statement](https://www.preprints.org/manuscript/202512.1305/v1#Informed_Consent_Statement)

[Data Availability Statement](https://www.preprints.org/manuscript/202512.1305/v1#Data_Availability_Statement)

[Acknowledgments](https://www.preprints.org/manuscript/202512.1305/v1#Acknowledgments)

[Conflicts of Interest](https://www.preprints.org/manuscript/202512.1305/v1#Conflicts_of_Interest)

[References](https://www.preprints.org/manuscript/202512.1305/v1#References)
...
Traditional DDA systems rely on heuristic functions or statistical models to track player success rates. For instance, creating a reference point for "optimal" play allows systems to intervene when a player's performance deviates significantly from the expected curve [ [3](https://www.preprints.org/manuscript/202512.1305/v1#B3-preprints-189740)]. However, simple reactive systems often fail to account for the temporal nature of skill acquisition — players learn and forget. To address this, tensor factorization techniques have been proposed to model player performance over time, allowing systems to forecast future failures and proactively tailor challenge sequences rather than merely reacting to immediate inputs [ [5](https://www.preprints.org/manuscript/202512.1305/v1#B5-preprints-189740), [6](https://www.preprints.org/manuscript/202512.1305/v1#B6-preprints-189740)].

2.2.2. Machine Learning in DDA

Recent systematic reviews indicate a paradigm shift from rule-based DDA to data-driven approaches [ [7](https://www.preprints.org/manuscript/202512.1305/v1#B7-preprints-189740)]. While earlier systems used simple "rubber-banding" mechanics, modern implementations utilize deep learning and reinforcement learning to create sophisticated opponent agents that adapt to human expertise in real-time [ [8](https://www.preprints.org/manuscript/202512.1305/v1#B8-preprints-189740), [9](https://www.preprints.org/manuscript/202512.1305/v1#B9-preprints-189740)]. Despite these advances, performance-based metrics remain a proxy for player experience; they measure what the player does, but not necessarily how they feel.

2.3. Affective Computing and Emotion-Based Adaptation

The field of Affective Computing, pioneered by Rosalind Picard, argues that for computers (and games) to interact naturally with humans, they must recognize, understand, and express emotions [ [10](https://www.preprints.org/manuscript/202512.1305/v1#B10-preprints-189740)]. This has led to the development of "Affective Game Computing," where the system closes the loop between the player's emotional state and the game environment.

2.3.1. Physiological and Behavioral Sensing

To infer emotional states, researchers have integrated physiological sensors (e.g., EEG, Heart Rate Variability) into gameplay. For example, the BIRAFFE experiments demonstrated that bio-signals could effectively measure reaction intensity, which, when combined with game context (e.g., a "Game Over" event), allows the system to label specific emotions and adjust gameplay to mitigate negative states [ [11](https://www.preprints.org/manuscript/202512.1305/v1#B11-preprints-189740)]. However, the requirement for physiological sensors is often intrusive and impractical for ubiquitous mobile gaming [ [8](https://www.preprints.org/manuscript/202512.1305/v1#B8-preprints-189740)].

2.3.2. Non-Invasive Inference

To overcome hardware limitations, recent research has explored non-invasive methods. Dialogue-Based Self-Reports (DBSR) integrate emotional assessment directly into NPC conversations, allowing games to adjust difficulty parameters like enemy speed based on reported frustration without breaking immersion [ [12](https://www.preprints.org/manuscript/202512.1305/v1#B12-preprints-189740)]. More recently, deep learning has enabled robust emotion recognition from facial expressions alone. Studies in 2025 have shown that Convolutional Neural Networks (CNNs) can successfully detect psychological states such as sadness, fear, or happiness from live player footage [ [13](https://www.preprints.org/manuscript/202512.1305/v1#B13-preprints-189740)]. In the mobile domain, emotion-aware frameworks combining facial analysis with gaze tracking have been shown to significantly reduce negative emotional responses (e.g., anger) and improve learning outcomes in educational games [ [14](https://www.preprints.org/manuscript/202512.1305/v1#B14-preprints-189740)].

2.4. Gap in Research: From Maintenance to Induction

While substantial progress has been made in maintaining Flow or detecting emotions [ [9](https://www.preprints.org/manuscript/202512.1305/v1#B9-preprints-189740)], a gap remains in actively inducing specific emotional states beyond simple satisfaction. Most existing systems act as "thermostats," attempting to return the player to a neutral state of engagement when they deviate [ [7](https://www.preprints.org/manuscript/202512.1305/v1#B7-preprints-189740)]. There is limited research on using deep learning not just to monitor, but to manipulate game parameters to provoke specific target emotions (e.g., inducing fear in a horror game or joy in a casual game) using standard mobile hardware.

2.5. Novelty of this Work

This research addresses the identified gaps through the following contributions:

**Input-Driven Emotion Inference:** We propose a deep learning framework that correlates facial expression data with raw player inputs. This enables non-intrusive emotion inference solely through gameplay behavior, even when the camera is unavailable, thereby mitigating the privacy and intrusion concerns associated with continuous monitoring [ [12](https://www.preprints.org/manuscript/202512.1305/v1#B12-preprints-189740)].

**Active Emotional Induction:** Unlike traditional DDA systems that aim solely for "comfort" or "Flow" [ [1](https://www.preprints.org/manuscript/202512.1305/v1#B1-preprints-189740), [2](https://www.preprints.org/manuscript/202512.1305/v1#B2-preprints-189740), [3](https://www.preprints.org/manuscript/202512.1305/v1#B3-preprints-189740)], our system modifies game parameters to actively induce target emotions, expanding the scope of adaptation from maintenance to emotional orchestration.

## 3. Ethical Considerations

We acknowledge the significant ethical implications inherent in systems designed to monitor and influence human emotional states. The manipulation of user affect by algorithmic systems has been a subject of scrutiny, highlighted by controversies such as the "emotional contagion" study on social media platforms [ [15](https://www.preprints.org/manuscript/202512.1305/v1#B15-preprints-189740)] and the emergence of "dark patterns" in game design [ [16](https://www.preprints.org/manuscript/202512.1305/v1#B16-preprints-189740)]. In the commercial gaming sector, patents suggest the existence of matchmaking algorithms explicitly designed to manipulate player satisfaction to drive microtransactions [ [17](https://www.preprints.org/manuscript/202512.1305/v1#B17-preprints-189740)], incentivizing the optimization of revenue over player well-being.
...
Together, Equations ( [1](https://www.preprints.org/manuscript/202512.1305/v1#FD1-preprints-189740)), ( [2](https://www.preprints.org/manuscript/202512.1305/v1#FD2-preprints-189740)) and ( [3](https://www.preprints.org/manuscript/202512.1305/v1#FD3-preprints-189740)) formalize a unified framework for emotion-driven game adaptation through predictive and generative modeling.

4.2. System Architecture

We developed a sophisticated, custom browser-based game platform using the Unity engine [ [18](https://www.preprints.org/manuscript/202512.1305/v1#B18-preprints-189740)] framework. This approach was selected to provide ease of access and broad compatibility, allowing players to participate on mobile devices without requiring any installation or download. This significantly lowered the barrier to entry, facilitating data collection effort.
...
The server performs data integrity checks immediately upon receipt, prior to storage in a structured database. Asynchronous message queues manage computationally intensive tasks, including emotion extraction from facial images captured during “data collection game-mode” using the Residual Masking Network [ [19](https://www.preprints.org/manuscript/202512.1305/v1#B19-preprints-189740)].
...
To address these limitations, we employ a proxy ground-truth approach based on automatic facial expression analysis. The assumption is that spontaneous facial expressions, while imperfect and subject to cultural and situational variation, provide a more immediate and less biased indicator of emotional state than self-reporting. We use a pre-trained facial emotion recognition network [ [19](https://www.preprints.org/manuscript/202512.1305/v1#B19-preprints-189740)] to analyze photographs of players taken during gameplay. The network assigns one of seven labels (anger, disgust, fear, joy, sadness, surprise, or neutral) [ [20](https://www.preprints.org/manuscript/202512.1305/v1#B20-preprints-189740)] to each image, which we then link to the corresponding game state data.

While we acknowledge that facial expressions are behavioral signals that may not always perfectly align with internal physiological states, they represent a necessary trade-off between accuracy and ecological validity in mobile gaming [ [21](https://www.preprints.org/manuscript/202512.1305/v1#B21-preprints-189740), [22](https://www.preprints.org/manuscript/202512.1305/v1#B22-preprints-189740)]. Unlike physiological sensors (e.g., EEG, GSR), which are often intrusive and impractical for widespread deployment [ [23](https://www.preprints.org/manuscript/202512.1305/v1#B23-preprints-189740)], or self-reports, which disrupt the player's immersion and flow [ [12](https://www.preprints.org/manuscript/202512.1305/v1#B12-preprints-189740)], facial analysis allows for continuous, non-invasive monitoring.

This reliance on facial analysis aligns with recent methodologies in adaptive game-based learning and Flow regulation, where webcam-based inference is accepted as a valid and sufficient proxy for real-time affective modeling [ [13](https://www.preprints.org/manuscript/202512.1305/v1#B13-preprints-189740), [14](https://www.preprints.org/manuscript/202512.1305/v1#B14-preprints-189740)]. It is also consistent with recent affective computing frameworks that prioritize the preservation of natural dynamics over the granular precision of invasive biosensors [ [24](https://www.preprints.org/manuscript/202512.1305/v1#B24-preprints-189740)]. This produces a proxy ground truth for player emotions, enabling us to annotate specific gameplay events with emotional information.
...
[Figure 5](https://www.preprints.org/manuscript/202512.1305/v1#preprints-189740-f005) presents their average distributions for each emotional state. These parameters directly influenced both gameplay progression and emotional responses. 
...
Both neural architectures were trained using CUDA on an NVIDIA RTX 3060 GPU. The main training parameters and configurations are summarized in [Table 1](https://www.preprints.org/manuscript/202512.1305/v1#preprints-189740-t001). 
...
Across selected emotions, mean absolute error values remained low ( [Figure 6](https://www.preprints.org/manuscript/202512.1305/v1#preprints-189740-f006)), indicating accurate prediction of future gameplay states. Class-dependent variation was observed, but differences were minor and attributable to dataset imbalance rather than architectural limitations. 

**Figure 6.** Diagram presenting the MAE of game state parameters per classified emotion.

Similarly, Kullback-Leibler divergence values between predicted and observed emotional distributions were consistently low ( [Figure 7](https://www.preprints.org/manuscript/202512.1305/v1#preprints-189740-f007)), demonstrating that the model captured both dominant and mixed emotional states. This indicates its suitability for tasks requiring recognition of overlapping affective responses. 

**Figure 7.** Diagram presenting the Kullbach-leibler divergence value per classified emotion.

Classification accuracy is reported in [Table 2](https://www.preprints.org/manuscript/202512.1305/v1#preprints-189740-t002), with the corresponding confusion matrix shown in [Figure 8](https://www.preprints.org/manuscript/202512.1305/v1#preprints-189740-f008). The disgust category was omitted from the final model, as the game's design deliberately excluded aversive stimuli, rendering the class statistically insignificant and contextually irrelevant. The model achieved balanced accuracy of 97.04%. 
...
Live gameplay experiments targeting fear and joy produced increases in value of 55.01% and 99.89%, respectively, relative to test set average values of selected emotions ( [Figure 12](https://www.preprints.org/manuscript/202512.1305/v1#preprints-189740-f012)). In the case of joy it is important to contextualize this result. Given the baseline scarcity of this emotion in survival gameplay, this optimization does not imply a continuous state of euphoria, but rather a successful system-driven increase in the frequency of positive valence events. The system effectively manipulated parameters to generate more frequent 'triumph loops,' which the model correctly predicted would elicit positive facial markers. 
