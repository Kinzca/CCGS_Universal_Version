...
[Skip to content](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#main)

[WCAG 2.1 Understanding Docs](https://www.w3.org/WAI/WCAG21/Understanding/)

Informative explanations, not required to meet WCAG

[About WCAG Understanding Docs](https://www.w3.org/WAI/WCAG21/Understanding/about)  

[All Understanding Docs](https://www.w3.org/WAI/WCAG21/Understanding/)

[Guideline: Distinguishable](https://www.w3.org/WAI/WCAG21/Understanding/distinguishable)

[Previous SC: Reflow](https://www.w3.org/WAI/WCAG21/Understanding/reflow)

[Next SC: Text Spacing](https://www.w3.org/WAI/WCAG21/Understanding/text-spacing)

Page Contents

[In Brief](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#brief)

[Success Criterion](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#success-criterion)

[Intent](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#intent)

[Benefits](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#benefits)

[Examples](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#examples)

[Related Resources](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#resources)

[Techniques](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#techniques)

[Key Terms](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#key-terms)

# Understanding [SC 1.4.11](https://w3.org/TR/WCAG21#non-text-contrast) Non-text Contrast (Level AA)
...
Visual information required to identify [user interface components](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-user-interface-component) and [states](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-state), except for inactive components or where the appearance of the component is determined by the [user agent](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-user-agent) and not modified by the author;
...
The intent of this success criterion is to ensure that user interface components (i.e., controls) and meaningful graphics are distinguishable by people with moderately low vision. The requirements and rationale are similar to those for large text in [1.4.3 Contrast (Minimum)](https://www.w3.org/WAI/WCAG21/Understanding/contrast-minimum). Note that this requirement does not apply to inactive user interface components.
...
Figure 2. **Pass:** A standard text input with a grey border ( `#767676` ) and white adjacent color outside the component
...
Using a change of contrast for focus and other states is a technique to differentiate the states. This is the basis for [G195: Using an author-supplied, visible focus indicator](https://www.w3.org/WAI/WCAG21/Techniques/general/G195), and more techniques are being added.

Relationship with Focus Visible

In combination with [2.4.7 Focus Visible](https://www.w3.org/WAI/WCAG21/Understanding/focus-visible), the visual focus indicator for a component must have sufficient contrast against the adjacent background when the component is focused, except where the appearance of the component is determined by the user agent and not modified by the author.
...
Figure 15. **Not in scope:** The change of background within the component is not in scope of non-text contrast. However, this would not pass [Use of color](https://www.w3.org/WAI/WCAG21/Understanding/use-of-color.html).
...
The browser's default link text color is covered by [1.4.3 Contrast (Minimum)](https://www.w3.org/WAI/WCAG21/Understanding/contrast-minimum). Since the underline is the same color as the text, which must meet at least 3:1 to pass, the default underline will always pass the requirements of Non-text Contrast.

Link text

Default focus style

Links are required to have a visible focus indicator by [2.4.7 Focus Visible](https://www.w3.org/WAI/WCAG21/Understanding/focus-visible.html). Where the focus style of the user agent is not adjusted on interactive controls (such as links, form fields or buttons) by the website (author), the default focus style is exempt from contrast requirements (but must still be visible).
...
A graphic with text embedded or overlaid conveys the same information, such as labels and values on a chart. Note Text within a graphic must meet [1.4.3 Contrast (Minimum)](https://www.w3.org/WAI/WCAG21/Understanding/contrast-minimum).
...
When text characters are used as symbols – used for their visual appearance, rather than expressing something in human language – they fall under the definition of [non-text content](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-non-text-content).
...
The techniques below each have testing criteria, and the related criteria for [Focus visible (2.4.7)](https://www.w3.org/WAI/WCAG21/Understanding/focus-visible), [Use of color (1.4.1)](https://www.w3.org/WAI/WCAG21/Understanding/use-of-color), and [Contrast minimum](https://www.w3.org/WAI/WCAG21/Understanding/contrast-minimum) also have techniques.
...
Each numbered item in this section represents a technique or combination of techniques that the Accessibility Guidelines Working Group deems sufficient for meeting this success criterion. A technique may go beyond the minimum requirement of the criterion. There may be other ways of meeting the criterion not covered by these techniques. For information on using other techniques, see [Understanding Techniques for WCAG Success Criteria](https://www.w3.org/WAI/WCAG21/Understanding/understanding-techniques), particularly the "Other Techniques" section.
...
[F78: Failure of Success Criterion 1.4.11 and 2.4.7 due to styling element outlines and borders in a way that removes or renders non-visible the visual focus indicator](https://www.w3.org/WAI/WCAG21/Techniques/failures/F78)
...
hardware and/or software that acts as a [user agent](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-user-agent), or along with a mainstream user agent, to provide functionality to meet the requirements of users with disabilities that go beyond those offered by mainstream user agents
...
information and sensory experience to be communicated to the user by means of a [user agent](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-user-agent), including code or markup that defines the content's [structure](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-structure), [presentation](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-presentation), and interactions

contrast ratio

(L1 + 0.05) / (L2 + 0.05), where

L1 is the [relative luminance](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-relative-luminance) of the lighter of the colors, and

L2 is the [relative luminance](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-relative-luminance) of the darker of the colors.
...
See also [sign language](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-sign-language).

non-text content

any content that is not a sequence of characters that can be [programmatically determined](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-programmatically-determined) or where the sequence is not expressing something in [human language](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-human-language)

Note

This includes [ASCII art](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-ascii-art) (which is a pattern of characters), emoticons, leetspeak (which uses character substitution), and images representing text

presentation

rendering of the [content](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-content) in a form to be perceived by users

programmatically determined

determined by software from author-supplied data provided in a way that different [user agents](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-user-agent), including [assistive technologies](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-assistive-technology), can extract and present this information to users in different modalities
...
A [separate page giving the relative luminance definition using MathML](https://www.w3.org/WAI/WCAG21/Understanding/relative-luminance.html) to display the formulas is available.
...
dynamic property expressing characteristics of a [user interface component](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-user-interface-component) that may change in response to user action or automated processes
...
The way the parts of a [web page](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-web-page) are organized in relation to each other; and

The way a collection of [web pages](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-web-page) is organized
...
Web browsers, media players, plug-ins, and other programs — including [assistive technologies](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-assistive-technology) — that help in retrieving, rendering, and interacting with web content.
...
a non-embedded resource obtained from a single URI using HTTP plus any other resources that are used in the rendering or intended to be rendered together with it by a [user agent](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#dfn-user-agent)
...
[Back to Top](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html#top)
...
[Email](mailto:public-agwg-comments@w3.org?subject=%5BUnderstanding%20and%20Techniques%20Feedback%5D) [Fork & Edit on GitHub](https://github.com/w3c/wcag/edit/main/understanding/21/non-text-contrast.html) [New GitHub Issue](https://github.com/w3c/wcag/issues/new)

**Date:** Updated 23 February 2026. [View this page's revision history.](https://github.com/w3c/wcag/commits/main/understanding/21/non-text-contrast.html)

**Developed by** [Accessibility Guidelines Working Group (AG WG) Participants](https://www.w3.org/groups/wg/ag/participants) (Co-Chairs: Alastair Campbell, Rachael Bradley Montgomery. W3C Staff Contact: Michael Cooper).

The content was developed as part of the [WAI-Core projects](https://www.w3.org/WAI/about/projects/#us) funded by U.S. Federal funds. The user interface was designed by the Education and Outreach Working Group ( [EOWG](https://www.w3.org/groups/wg/eowg/participants)) with contributions from Shadi Abou-Zahra, Steve Lee, and Shawn Lawton Henry as part of the [WAI-Guide](https://www.w3.org/WAI/about/projects/wai-guide/) project, co-funded by the European Commission.
...
[LinkedIn](https://www.linkedin.com/company/w3c-wai/)

[Mastodon](https://w3c.social/@wai)

[YouTube](https://www.youtube.com/channel/UCU6ljj3m1fglIPjSjs2DpRA/playlists/)

[Home](https://www.w3.org/WAI/)

[Contact](https://www.w3.org/WAI/about/contacting/)

[Site map](https://www.w3.org/WAI/sitemap/)

[Support WAI](https://www.w3.org/WAI/about/support/)

[News](https://www.w3.org/WAI/news/)

[Accessibility statement](https://www.w3.org/WAI/about/accessibility-statement/)

[All Translations](https://www.w3.org/WAI/translations/)

[Resources for roles](https://www.w3.org/WAI/roles/)

Copyright © 2026 [World Wide Web Consortium](https://www.w3.org/).

W3C ® [liability](https://www.w3.org/policies/#disclaimers), [trademark](https://www.w3.org/policies/#trademarks) and [permissive license](https://www.w3.org/copyright/software-license/) rules apply unless otherwise noted. See [Permission to Use WAI Material](https://www.w3.org/WAI/about/using-wai-material/).